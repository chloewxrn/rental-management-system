...
// Observer DP at comboBox, sortCB, createBtn, sortBtn, itemStateChanged
// Wong Yi Teng
// User interface for report 
public class ReportGenerate extends JPanel implements ActionListener, ItemListener {
    ...
    String[] category = { "Select an option", "Property Type", "Property Status", "Township", "Facilities",
            "Rental Price", "Owner", "Agent", "Rental Rate", "All property" };
    ...
    String[] rentalPrice = { "Select Rental Price", "< RM1000", "RM1000-RM2000", "RM2001-RM3000", "RM3001-RM4000",
            "RM4001-RM5000", ">RM5000" };
    ...
    public ReportGenerate() {
        ...
        String[] propertyType = tempPropertyType.stream().distinct().collect(Collectors.toList())
                .toArray(new String[] {});
        ...
        // Wong Yi Teng
        // Retrieve ALL taman from Property.txt to save in comboBox
        ...
        // To get the user selection from sub combo box and display the properties that
    ...
    // Chin Pei Wern
    // get the action performed in the jcombo box for displaying type for list of
    // properties
    public void actionPerformed(ActionEvent e) {
        String item = (String) comboBox.getSelectedItem();
    ...
    private void DisplayProperty(Property property) {
        JLabel testingLabel = new JLabel("<html><br> " + "Property ID : " + property.propertyID
                + "<br> Advertiser ID : " + property.advertiserID + "<br> Property Type : " + property.type
                + "<br> Status : " + property.status + "<br> Price:  RM " + property.rentalPrice + "<br> Rate:  RM "
                + property.rentalRate + " per sq. ft" + "<br> UnitSize : " + property.unitSize + " sq ft."
                + "<br> Township : " + property.township + "<br> Address: " + property.address + "<br> Facilities: "
                + property.facilities + " | Room: " + property.roomNum + " | Bathroom: " + property.bathroomNum
                + "<br> Contact Number : " + property.advertiserContact + "(" + property.advertiserName + ")"
                + "<br> Status: " + property.status + "</br> </html>");
